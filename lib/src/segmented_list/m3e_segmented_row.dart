  ...
  Widget build(BuildContext context) {
    ...
    final rowChildren = List.generate(count, (index) {
      ...
      final item = M3ESegmentedItem(
        ...
        gap: effectiveGap,
        // A hidden child owns no gap and no inner padding, so its slot collapses
        // to exactly zero extent once its own child does — while keeping its
        // normal surface rather than flashing disabled styling for the length
        // of the collapse.
