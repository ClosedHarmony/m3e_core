...
class _M3EHorizontalFloatingToolbarState
  ...
  Widget build(BuildContext context) {
    final effectiveColors =
        widget.decoration?.colors ?? M3EFloatingToolbarDefaults.standardColors(context);
    final effectiveShape =
        widget.decoration?.shape ?? M3EFloatingToolbarDefaults.containerShape;
    final effectivePadding =
        widget.decoration?.contentPadding ?? M3EFloatingToolbarDefaults.contentPadding;
            ...
            children: [
              if (widget.leadingContent != null)
                AnimatedContentVisibility(
                  ...
                  isVertical: false,
                  sizeMotion: effectiveMotion ?? M3EMotion.expressiveSpatialFast,
                  opacityMotion: effectiveMotion ?? M3EMotion.standardEffectsFast,
...
class _M3EFabHorizontalFloatingToolbarState
  ...
  void initState() {
    ...
    final motionSpec = widget.decoration?.motion ?? M3EMotion.expressiveSpatialFast;
